    ...
    juce::Slider& slider)
{
    ...
    g.setColour(Colour(150u, 187u, 194u));
    g.fillEllipse(bounds);

    g.setColour(Colour(41u, 147u, 169u));
...
SimpleEQAudioProcessorEditor::SimpleEQAudioProcessorEditor(SimpleEQAudioProcessor& p)
    ...
    analyzerBypassButtonAttachment(audioProcessor.apvts, "Analyzer Enabled", analyzerEnabledButton)
{
...
void SimpleEQAudioProcessorEditor::resized()
{
    ...
    float hRatio = 25.f / 100.f; //JUCE_LIVE_CONSTANT(33) / 100.f; (using this to adjust the sizing)
